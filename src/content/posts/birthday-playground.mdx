...
draft: False
---
import BirthdayChart from "../../components/d3_bd.svelte";
...
(There should be a chart below. If it didn't show please relaod the page.)

<BirthdayChart client:only='svelte' />
